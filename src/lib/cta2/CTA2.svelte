...
<div class="xl:pb-24 pb-12 sm:pt-0 pt-8 cta2">
      ...
      <div class="container mx-auto">
        <div id="subscribe2" data-aos="zoom-out" class="xl:w-3/5 lg:w-3/5 w-10/12 mx-auto p-8 bg-black bg-opacity-60 block">
          ...
          <div class="flex flex-col xl:flex-row lg:flex-row md:flex-row w-full justify-center">
            ...
            <button  on:click={submitBtn} id="ClickSubscribeButton2" class="focus:outline-none font-bold hidden xl:block lg:block md:block sm:block bg-our-blue focus:our-blue py-3 px-8 rounded text-gray-200 hover:ring-2 hover:ring-our-blue text-lg xl:ml-5 lg:ml-5 md:ml-5 bg-opacity-100">
              Subscribe
            </button>
            <button  on:click={submitBtn} id="ClickSubscribeMobileButton2" class="focus:outline-none font-bold block xl:hidden lg:hidden md:hidden sm:hidden bg-our-blue focus:our-blue transition duration-150 ease-in-out hover:ring-2 hover:ring-our-blue rounded text-gray-200 px-6 py-2 text-sm mt-2">
              Subscribe
            </button>
          </div>
        </div>
