        ...
        <ul>
          <li class="faq1 py-6 border-gray-200 border-solid border-b">
            <div class="flex justify-between items-center cursor-pointer">
              <p class="text-gray-200 text-base md:text-xl xl:text-2xl w-10/12 dark:text-gray-200" on:click={clickmenu}>
                What is Renderpub?
              </p>
              <div data-menu class="cursor-pointer" on:click={clickmenu}>
                <svg
          ...
          <li class="faq1 py-6 border-gray-200 border-solid border-b">
            ...
            <p data-content id="noclick" class="hidden pt-2 md:pt-3 lg:pt-5 text-gray-200 px-4 md:px-8 text-sm md:text-base xl:text-lg rounded-b-lg dark:text-gray-200">
              The best place to find community and support is the <a id="noclick" href="https://discord.com/invite/ASXjnaWn2X" target="_blank" style="text-decoration: underline; color:#6ab8e6">Renderpub Discord Server.</a> Additionally, you can reach us at <a style="text-decoration: underline; color:#6ab8e6" href="mailto:infoon:renderpub.com?subject=Renderpub Enquiry">infoon:renderpub.com</a> for correspondence.
            </p>
          </li>
          <li class="faq1 py-6 border-gray-200 border-solid border-b">
            <div class=" flex justify-between items-center cursor-pointer">
